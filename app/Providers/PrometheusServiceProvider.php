...
class PrometheusServiceProvider extends ServiceProvider
{
    public function register()
    {
        ...
        Prometheus::addGauge('url_shortener_total_urls', fn() => \App\Models\SUrl::count());
        Prometheus::addGauge('url_shortener_unique_users', fn() => \App\Models\User::distinct()->count('id'));
